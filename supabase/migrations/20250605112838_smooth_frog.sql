/*
  ...
  1. Changes
    - Adds status and date columns to projects table
    - Creates tables for project timelines, resources, updates, and discussions
    - Enables RLS and sets up security policies
    - Adds update triggers for timestamp management

  2. New Tables
    - project_timelines: Track project phases and progress
    - project_resources: Store project-related documents and links
    - project_updates: Project announcements and updates
    - project_discussions: Comments and discussions

  3. Security
    - RLS enabled on all new tables
    - Policies for project participants and creators
    - Granular access control for discussions
*/
...
-- Create update triggers with existence check
DO $$
BEGIN
  IF NOT EXISTS (
